...
class Binance {
	...
	public function cancel($symbol, $orderid) {
		return $this->signedRequest("v3/order",["symbol"=>$symbol, "orderId"=>$orderid, "recvWindow"=>60000], "DELETE");
	}
	...
	public function orders($symbol, $limit = 500) {
		return $this->signedRequest("v3/allOrders",["symbol"=>$symbol, "limit"=>$limit, "recvWindow"=>60000]);
	}
	...
	public function account() {
		return $this->signedRequest("v3/account",["recvWindow"=>60000]);
	}
